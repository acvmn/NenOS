...
del boot.bin
del kernel.bin
..\xorriso.exe -as mkisofs \ -volid "NenOS" \ -isohybrid-mbr NenOS.bin \ -c boot.cat \ -b NenOS.bin \ -no-emul-boot \ -boot-load-size 16 -boot-info-table \ -eltorito-alt-boot \ -isohybrid-gpt-basdat \ -o NenOS.iso
del NenOS.bin
